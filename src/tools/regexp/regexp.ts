export class RegexpService {
    ...
    this.regMap.set('username_5_20', /^[A-Za-z\d_-]{5,20}$/);
    this.regMap.set('password_8', /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)[\w\W]{8,}$/);
    ...
    this.regMap.set('ipv6', /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))＊$/); // source: https://ihateregex.io/expr/ipv6/
    this.regMap.set('ipv6_mask', /^((([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/\d{1,3})*$/);
    ...
    this.regMap.set('single_port_interval', /^([1-9](\d)*)([\\-][1-9](\d*))?$/); //1 or 10-15
    ...
    this.regMap.set('dscp', /^(\d|[1-5]\d|6[0-3])$/); //0~63
    this.regMap.set('queue', /^[0-7]$/); //0~7
    this.regMap.set('ttl', /^([1-9]|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])$/); //1~255
    ...
    this.regMap.set('snooping_max_binding', /^([1-9]|[1-2]\d|3[0-2])$/); //1-32
    ...
    this.regMap.set('vlan_1_to_4093', /^([1-9]\d{0,2}|[1-3]\d{3}|40[0-8]\d|409[0-3])$/); // 1-4093
    this.regMap.set('vlan_1_to_4000', /^([1-9]\d{0,2}|[1-3]\d{3}|4000)$/); // 1-4000
    this.regMap.set('vlan_1_to_4094_range', /^([1-9]|[1-9]\d{1,2}|[1-3]\d{3}|40[0-8]\d|409[0-4]|([1-9]|[1-9]\d{1,2}|[1-3]\d{3}|40[0-8]\d|409[0-4])\-([1-9]|[1-9]\d{1,2}|[1-3]\d{3}|40[0-8]\d|409[0-4]))$/); // 1~4094 or range text: 1-5, 250-4094
    this.regMap.set('vlan_2_to_4094', /^([2-9]|[1-9]\d{1,2}|[1-3]\d{3}|40[0-8]\d|409[0-4])$/); // 2-4094
    this.regMap.set('vlan_0_to_4094', /^(\d{1,3}|[1-3]\d{3}|40[0-8]\d|409[0-4])$/); // 0-4094
    this.regMap.set('multi_vlan', /^(([1-9]\d{0,2}|[1-3]\d{3}|40[0-8]\d|409[0-4])[\\,])*([1-9]\d{0,2}|[1-3]\d{3}|40[0-8]\d|409[0-4])$/); //1~4094 1,2,3
    ...
    this.regMap.set('qos_policy_pir', /^(\d{1,7}|[1-3]\d{7}|40000000)$/); //0~40000000
    this.regMap.set('qos_policy_bc', /^([1-9]\d{3,7}|1[0-1]\d{7}|12[0-7]\d{6})$/); //1000-128000000
    this.regMap.set('qos_policy_be', /^([1-9]\d{3,7}|1[0-1]\d{7}|12[0-7]\d{6})$/); //1000-128000000
    this.regMap.set('qos_policy_bp', /^([1-9]\d{3,7}|1[0-1]\d{7}|12[0-7]\d{6})$/); //1000-128000000
    this.regMap.set('qos_policy_ether_type_may_with_mask', /^([a-fA-F0-9]){1,4}(\/[a-fA-F0-9]{1,4})?$/); //0-ffff, 806/FFFF
    this.regMap.set('qos_policy_vid_may_with_mask', /^([1-9]\d{0,2}|[1-3]\d{3}|40[0-8]\d|409[0-4])(\/([1-9]\d{0,2}|[1-3]\d{3}|40[0-8]\d|409[0-4]))?$/); // 1-4094, 1-4094/4094
    this.regMap.set('qos_policy_mac_may_with_mask', /^(([A-Fa-f0-9]{2}:){5}[A-Fa-f0-9]{2}|([A-Fa-f0-9]{2}-){5}[A-Fa-f0-9]{2})(\/(([A-Fa-f0-9]{2}:){5}[A-Fa-f0-9]{2}|([A-Fa-f0-9]{2}-){5}[A-Fa-f0-9]{2}))?$/); // mac, mac/FF:FF:FF:FF:FF:FF
    this.regMap.set('qos_policy_ip_may_with_mask', /^((?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\/(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?))?)$/); // IP, IP/255.255.255.0
    this.regMap.set('qos_policy_port_may_with_mask', /^\d+(\/\d+)?$/); // 80, 80/80
    ...
    this.regMap.set('sflow_rate', /^(25[6-9]|2[6-9]\d|[3-9]\d{2}|[1-9]\d{3,6}|1[0-5]\d{6}|16[0-6]\d{5}|167[0-6]\d{4}|1677[0-6]\d{3}|16777[01]\d{2}|1677720\d|1677721[0-5])$/); //256~16777215
    ...
    this.regMap.set('num_1_to_65535', /^([1-9]|[1-9]\d{1,3}|[1-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d|6553[0-5])$/); //1-65535
    this.regMap.set('num_0_to_65535', /^(\d|[1-9]\d{1,3}|[1-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d|6553[0-5])$/); // 0~65535
    this.regMap.set('num_0_to_255', /^([0-9]|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])$/); // 0~255
    ...
    this.regMap.set('port_utilization_interval', /^([3-9]\d|[1-2]\d{2}|300)$/); // 30-300
    this.regMap.set('port_range', /^(\d{1}|[1-9]\d{1,3}|[1-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d|6553[0-5])-(\d{1}|[1-9]\d{1,3}|[1-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d|6553[0-5])$/); // format:'xxxxx-xxxxx', example: '0-65535'
  }
